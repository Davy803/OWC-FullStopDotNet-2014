...
namespace FullStopDotNet2014.Web.Resources
{
    public static class TextResources 
    {
	    ...
	    /// <summary>
        /// Goodbye <b>Lorem </b><i>ipsum </i>dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
        ...
        public static IHtmlString LoremIpsum 
        {
            get 
            {
                return new HtmlString((string)resourceProvider.GetResource("LoremIpsum", CultureInfo.CurrentUICulture.Name));
            }
        }        
    }  
