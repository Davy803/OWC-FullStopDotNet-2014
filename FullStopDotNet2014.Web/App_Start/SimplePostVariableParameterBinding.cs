...
{
    /// <summary>
    /// Added the ability to use simple POST parameters in WebAPI controllers without needed to create a wrapper class 
    /// Copied from: http://weblog.west-wind.com/posts/2012/Sep/11/Passing-multiple-simple-POST-Values-to-ASPNET-Web-API
    /// </summary>
